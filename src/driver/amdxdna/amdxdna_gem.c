...
{
	struct iosys_map map = IOSYS_MAP_INIT_VADDR(abo->mem.kv_addr);
			       ...
			       struct amdxdna_drm_create_bo *args, struct drm_file *filp)
{
	...
	/* Further tweak the bo setup based on the newly created SHARE BO. */
