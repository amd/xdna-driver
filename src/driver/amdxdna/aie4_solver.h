...
#ifndef _AIE4_SOLVER_H
#define _AIE4_SOLVER_H
 ...
 */
void *aie4_xrsm_init(struct init_config *cfg);
 ...
 *      necessary lock.
 */
int aie4_xrs_allocate_resource(void *hdl, struct alloc_requests *req, void *cb_arg);
 ...
 */
int aie4_xrs_release_resource(void *hdl, u64 rid);
