...
#define NPU1_PSP_PSP_CMD_REG_ADDR	MPNPU_PUB_SCRATCH2
#define NPU1_PSP_PSP_ARG0_REG_ADDR	MPNPU_PUB_SCRATCH3
#define NPU1_PSP_PSP_ARG1_REG_ADDR	MPNPU_PUB_SCRATCH4
#define NPU1_PSP_PSP_ARG2_REG_ADDR	MPNPU_PUB_SCRATCH9
#define NPU1_PSP_PSP_INTR_REG_ADDR	MPNPU_PUB_SEC_INTR
#define NPU1_PSP_PSP_STATUS_REG_ADDR	MPNPU_PUB_SCRATCH2
#define NPU1_PSP_PSP_RESP_REG_ADDR	MPNPU_PUB_SCRATCH3
/* <device name>_<bar>_<enum name>_ADDR, see enum npu_smu_reg_idx */
#define NPU1_SMU_SMU_CMD_REG_ADDR	MPNPU_PUB_SCRATCH5
#define NPU1_SMU_SMU_ARG_REG_ADDR	MPNPU_PUB_SCRATCH7
#define NPU1_SMU_SMU_INTR_REG_ADDR	MPNPU_PUB_PWRMGMT_INTR
#define NPU1_SMU_SMU_RESP_REG_ADDR	MPNPU_PUB_SCRATCH6
#define NPU1_SMU_SMU_OUT_REG_ADDR	MPNPU_PUB_SCRATCH7
/* <device name>_<bar>_<enum name>_ADDR, see enum npu_sram_reg_idx */
#define NPU1_SRAM_MBOX_CHANN_OFF_ADDR	MPNPU_SRAM_X2I_MAILBOX_0
#define NPU1_SRAM_FW_ALIVE_OFF_ADDR	MPNPU_SRAM_I2X_MAILBOX_15
