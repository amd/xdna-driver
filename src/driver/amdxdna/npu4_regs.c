...
static const struct aie2_supported_fw_ver npu4_supported_fw_vers[] = {
	{ .major = 6, .min_fw_version = AIE2_FW_VERSION(6, 12) },
};

const struct amdxdna_dev_priv npu4_dev_priv = {
	.fw_path              = "amdnpu/17f0_10/npu.dev.sbin",
	.supported_fw_vers    = npu4_supported_fw_vers,
	.num_supported_fw_vers = ARRAY_SIZE(npu4_supported_fw_vers),
