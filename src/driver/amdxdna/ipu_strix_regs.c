...
#define STRIX_PSP_PSP_CMD_REG_ADDR	MP0_C2PMSG_123
#define STRIX_REG_PSP_ARG0_REG_ADDR	MPIPU_PUB_SCRATCH3
#define STRIX_REG_PSP_ARG1_REG_ADDR	MPIPU_PUB_SCRATCH4
#define STRIX_REG_PSP_ARG2_REG_ADDR	MPIPU_PUB_SCRATCH9
#define STRIX_PSP_PSP_INTR_REG_ADDR	MP0_C2PMSG_73
#define STRIX_PSP_PSP_STATUS_REG_ADDR	MP0_C2PMSG_123
#define STRIX_REG_PSP_RESP_REG_ADDR	MPIPU_PUB_SCRATCH3
/* <device name>_<bar>_<enum name>_ADDR, see enum ipu_smu_reg_idx */
#define STRIX_SMU_SMU_CMD_REG_ADDR	MP1_C2PMSG_0
#define STRIX_SMU_SMU_ARG_REG_ADDR	MP1_C2PMSG_60
#define STRIX_SMU_SMU_INTR_REG_ADDR	MMIPU_APERTURE4_BASE
#define STRIX_SMU_SMU_RESP_REG_ADDR	MP1_C2PMSG_61
#define STRIX_SMU_SMU_OUT_REG_ADDR	MP1_C2PMSG_60
/* <device name>_<bar>_<enum name>_ADDR, see enum ipu_sram_reg_idx */
#define STRIX_SRAM_MBOX_CHANN_OFF_ADDR	MPIPU_SRAM_X2I_MAILBOX_0
#define STRIX_SRAM_FW_ALIVE_OFF_ADDR	MPIPU_SRAM_X2I_MAILBOX_15

/* PCIe BAR Index for Phoenix Ryzen 7040 */
#define STRIX_REG_BAR_INDEX	0
#define STRIX_MBOX_BAR_INDEX	0
#define STRIX_PSP_BAR_INDEX	4
#define STRIX_SMU_BAR_INDEX	5
#define STRIX_SRAM_BAR_INDEX	2
/* Associated BARs and Apertures */
#define STRIX_REG_BAR_BASE	MMIPU_APERTURE0_BASE
#define STRIX_MBOX_BAR_BASE	MMIPU_APERTURE0_BASE
#define STRIX_PSP_BAR_BASE	MMIPU_APERTURE3_BASE
#define STRIX_SMU_BAR_BASE	MMIPU_APERTURE4_BASE
#define STRIX_SRAM_BAR_BASE	MMIPU_APERTURE1_BASE

#define STRIX_PSP_OFFSETS(_dev) \
{ \
...
const IPU_DEFINE_DEV_INFO_PSP(STRIX, "RyzenAI-Strix", 17f0, STRIX_PSP_OFFSETS,
