...
#if !defined(_AMDXDNA_MAILBOX_TRACE_H_) || defined(TRACE_HEADER_MULTI_READ)
#define _AMDXDNA_MAILBOX_TRACE_H_

#include <linux/stringify.h>
#include <linux/tracepoint.h>

#undef TRACE_SYSTEM
#define TRACE_SYSTEM amdxdna_mbox
#define TRACE_INCLUDE_FILE amdxdna_mailbox_trace
...
#endif /* !defined(_AMDXDNA_MAILBOX_TRACE_H_) || defined(TRACE_HEADER_MULTI_READ) */
