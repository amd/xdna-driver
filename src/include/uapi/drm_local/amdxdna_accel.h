...
#define	DRM_AMDXDNA_GET_STATE		7
 ...
 *						DRM_AMDXDNA_QUERY_FRAME_BOUNDARY_PREEMPT_STATE
 *					Set:
...
/**
 * struct amdxdna_drm_get_state - Get some information from the AIE hardware.
...
#define	DRM_AMDXDNA_QUERY_FRAME_BOUNDARY_PREEMPT_STATE	13
	__u32 param; /* in */
...
#define DRM_IOCTL_AMDXDNA_GET_STATE \
	DRM_IOWR(DRM_COMMAND_BASE + DRM_AMDXDNA_GET_STATE, \
		 struct amdxdna_drm_get_state)
