...
//uint32_t readMcCodeFile(char *file_name, uint32_t *data)
//{
...
//}
//
//void dumpMcCodeFile(char *file_name, uint32_t *data, uint32_t size)
//{
                   ...
                   uint64_t ddr_base_inter, uint32_t *mc_code_ddr, uint32_t mc_code_ddr_size_bytes)
{
  ...
  //// mc_code_ddr_size is in bytes, pc is in words. So divide by 4
