...
std::vector<test_case> test_list {
  ...
  test_case{ "measure no-op kernel latency", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_latency, { IO_TEST_NOOP_RUN, IO_TEST_IOCTL_WAIT, 32000 }
  },
  ...
  test_case{ "measure no-op kernel throughput chained command", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_runlist_throughput, { IO_TEST_NOOP_RUN, IO_TEST_IOCTL_WAIT, 32000 }
  },
  ...
  test_case{ "measure no-op kernel latency chained command", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_runlist_latency, { IO_TEST_NOOP_RUN, IO_TEST_IOCTL_WAIT, 32000 }
  },
  test_case{ "measure no-op kernel throughput", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_throughput, { IO_TEST_NOOP_RUN, IO_TEST_IOCTL_WAIT, 32000 }
  },
  test_case{ "measure no-op kernel latency (polling)", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_latency, { IO_TEST_NOOP_RUN, IO_TEST_POLL_WAIT, 32000 }
  },
  test_case{ "measure no-op kernel throughput (polling)", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_throughput, { IO_TEST_NOOP_RUN, IO_TEST_POLL_WAIT, 32000 }
  },
  test_case{ "measure no-op kernel latency chained command (polling)", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_runlist_latency, { IO_TEST_NOOP_RUN, IO_TEST_POLL_WAIT, 32000 }
  },
  test_case{ "measure no-op kernel throughput chained command (polling)", {},
    TEST_POSITIVE, dev_filter_xdna, TEST_io_runlist_throughput, { IO_TEST_NOOP_RUN, IO_TEST_POLL_WAIT, 32000 }
  },
