...
#else
#define AMDXDNA_ERR_NUM_MASK		GENMASK_ULL(15, 0)
#define AMDXDNA_ERR_DRV_MASK		GENMASK_ULL(23, 16)
#define AMDXDNA_ERR_SEV_MASK		GENMASK_ULL(31, 24)
#define AMDXDNA_ERR_MOD_MASK		GENMASK_ULL(39, 32)
#define AMDXDNA_ERR_CLASS_MASK		GENMASK_ULL(47, 40)
#endif
...
#else
#define AMDXDNA_EXTRA_ERR_COL_MASK	GENMASK_ULL(7, 0)
#define AMDXDNA_EXTRA_ERR_ROW_MASK	GENMASK_ULL(15, 8)
#endif
